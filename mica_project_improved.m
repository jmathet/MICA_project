function varargout = mica_project_improved(varargin)
% MICA_PROJECT_IMPROVED MATLAB code for mica_project_improved.fig
%      MICA_PROJECT_IMPROVED, by itself, creates a new MICA_PROJECT_IMPROVED or raises the existing
%      singleton*.
%
%      H = MICA_PROJECT_IMPROVED returns the handle to a new MICA_PROJECT_IMPROVED or the handle to
%      the existing singleton*.
%
%      MICA_PROJECT_IMPROVED('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LOAD_SIN.M with the given input arguments.
%
%      MICA_PROJECT_IMPROVED('Property','Value',...) creates a new MICA_PROJECT_IMPROVED or raises the
...
% Last Modified by GUIDE v2.5 16-May-2018 11:37:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @mica_project_improved_OpeningFcn, ...
    'gui_OutputFcn',  @mica_project_improved_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function mica_project_improved_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = mica_project_improved_OutputFcn(hObject, eventdata, handles)
